	...
	<div class="content">
		<div class="pag-nav">
			<ul class="p-list">
				...
				<li class="act">&nbsp;wantBook</li>
			</ul>
		</div>
		<div class="coats">
			<h3 class="c-head">Posted a Wishlist Item</h3>
			<p>The following details have been added to your wishlist.</p>
		</div>
		<div class="contact-box">
			<div class="form">
				<small>Book Title</small>
				<div class="text">
					<input type="text" value=${postinfo.title} readonly="readonly"/>
				</div>
			</div>
			<div class="form">
				<small>Post Date</small>
				<div class="text">
					<input type="text" value=${postinfo.date} readonly="readonly"/>
				</div>
			</div>
			<div class="clearfix"></div>
			<div class="form">
				...
				<div class="text">
					<input type="text" value=${postinfo.price} readonly="readonly" />
				</div>
			</div>
			<div class="form">
				<small>Description</small>
				<div class="text">
					<input type="text" value=${postinfo.description} readonly="readonly" />
				</div>
			</div>	
		</div>
	</div>
