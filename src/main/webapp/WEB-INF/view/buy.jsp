...
<section id="main">
	<div class="content">
		...
		<div class="coats sing-c">
			<h3 class="c-head">Seller Notified</h3>
			<p>The seller of the book has been notified about your interest to buy the book.</p>
			<p>Buy more books<a href="books.html"> here</a>.</p>
		</div>
	</div>
</section>
</div>
