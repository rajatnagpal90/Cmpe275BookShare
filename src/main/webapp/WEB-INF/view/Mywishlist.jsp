	...
	<div class="content">
		<div class="pag-nav">
			<ul class="p-list">
				...
				<li class="act">&nbsp;Wishlist</li>
			</ul>
		</div>
		<div class="coats sing-c">
			<h3 class="c-head">Wishlist</h3>
			<p>---------------------------------------------------------------------------------</p>
			<c:forEach var="post" items="${wishlist}">
		      <p>Book Name : ${post.title}</p>
              <p>Book ISBN : ${post.ISBN}</p>
              <p>Book Description : ${post.description}</p>
              <p>Book ISBN : ${post.price}</p>
              <p>Book ISBN : ${post.date}</p>
              <p>---------------------------------------------------------------------------------</p>
              <hr> 
            </c:forEach>
		</div>
