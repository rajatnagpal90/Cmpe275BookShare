	...
	<div class="content">
		<div class="pag-nav">
			<ul class="p-list">
				...
				<li class="act">&nbsp;Buyer</li>
			</ul>
		</div>
		<div class="coats">
			<h3 class="c-head">Buyer</h3>
			<p></p>
		</div>
		<div class="row about-row">
			<div class="col-md-6 about-col">
				<a href="wantBook.html">
				<img src="${pageContext.request.contextPath}/resources/images/request.jpg" alt="" class="img-responsive" height="42" width="42">
				<div class="who">
			...
			<div class="col-md-6 about-col">
				...
				<img src="${pageContext.request.contextPath}/resources/images/wishlist.jpg" alt="" class="img-responsive" height="42" width="42">
				<div class="who">
					<h3>Wishlist</h3>
				</div>
				</a>
