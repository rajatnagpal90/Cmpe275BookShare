	...
	<div class="content">
		<div class="pag-nav">
			<ul class="p-list">
				...
				<li class="act">&nbsp;Seller</li>
			</ul>
		</div>
		<div class="coats">
			<h3 class="c-head">Seller</h3>
			<p></p>
		</div>
		<div class="row about-row">
			<div class="col-md-6 about-col">
				<a href="addBook.html">
				<img src="${pageContext.request.contextPath}/resources/images/post.jpg" alt="" class="img-responsive" align="middle">
				<div class="who">
					<h3>Post a Book.</h3>
				</div>
				</a>
			...
			<div class="col-md-6 about-col">
				...
				<img src="${pageContext.request.contextPath}/resources/images/upload.jpg" alt="" class="img-responsive" align="middle">
				<div class="who">
					<h3>Upload Image.</h3>
				</div>
				</a>
